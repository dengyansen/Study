...
public class ChatServer {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("ChatServer run in 8080");
    ...
    private static class ChatHolder {
        ...
        public static void join(SocketChannel socketChannel) {
            ...
            send(socketChannel, "you join 您的id为：" + userId + "\n\r");
            for (SocketChannel channel : USER_MAP.keySet()) {
                send(channel, userId + "other join 加入了群聊" + "\n\r");
            }
        ...
        public static void quit(SocketChannel socketChannel) {
            ...
            send(socketChannel, "you exit 您退出了群聊" + "\n\r");
